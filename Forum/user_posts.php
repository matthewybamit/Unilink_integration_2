...
<div class="forum-sidebar">
    ...
    <button class="forum-btn active" onclick="location.href='user_posts.php?user_id=<?= $_SESSION['uid'] ?>'"><i class="fas fa-file-alt forum-btn-icon"></i> Posts </button>
    <button class="forum-btn" onclick="location.href='liked_posts.php?user_id=<?= $_SESSION['uid'] ?>'"><i class="fas fa-heart forum-btn-icon"></i> Liked Posts </button>
